...
export default function CommunityGrid({
  ...
  // We now manage the search state locally within the grid
  ...
  return (
    <div className="space-y-12">
      {/* Search Bar integrated into the Client component */}
            ...
            <div className="flex justify-between items-start mb-4 relative z-10">
              <div className="flex-1">
                ...
                <Link
                  ...
                  className="inline-block mt-2 text-[8px] font-black uppercase tracking-tighter bg-kindred-lime text-kindred-dark px-2 py-1 rounded-lg hover:scale-105 transition-transform shadow-sm"
                >
                  View Profile 👤
                </Link>
              </div>
