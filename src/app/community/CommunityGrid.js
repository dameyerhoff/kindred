...
export default function CommunityGrid({
  ...
  // Filtering profiles based on Name, City, or Tags
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
      {filteredProfiles.length > 0 ? (
        filteredProfiles.map((profile) => {
          ...
          return (
            <div
              ...
              className="p-6 rounded-[2.5rem] border-2 border-kindred-lime shadow-kindred transition-all duration-300 group relative overflow-hidden flex flex-col hover:brightness-110"
            >
                      ...
                      ${
                        isCurrentSuccess
                          ...
                          : isCurrentSending
                            ...
                            : "bg-kindred-lime text-kindred-dark hover:brightness-110"
                      }`}
                  >
                    {isCurrentSuccess
                      ? "Sent! ✨"
        ...
        <div className="col-span-full py-20 text-center border-2 border-dashed border-white/10 rounded-[2.5rem]">
          <p className="text-kindred-text/40 font-black uppercase tracking-[0.4em]">
            No matching Kindred Souls found
          </p>
        </div>
      )}
    </div>
